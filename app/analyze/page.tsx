    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {error && (
            <div className="flex items-center gap-2 mt-4 bg-danger/10 text-danger text-sm font-medium px-4 py-3 rounded-xl">
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-6 w-full bg-gradient-to-r from-brand to-brand-dark text-white px-8 py-4 rounded-2xl font-semibold text-base hover:shadow-xl hover:shadow-brand/25 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
